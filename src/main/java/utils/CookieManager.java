...
public class CookieManager {
	/* 쿠키생성 : 생성시 response내장객체가 필요하므로 매개변수를 통해 JSP에서 전달받아야
		한다. 나머지는 쿠키명, 쿠키값, 유효시간 설정을 위한 값이다. */
	...
	/* 쿠키삭제 : 쿠키는 삭제를 위한 별도의 메소드가 없다. 유지시간을 0으로 설정하면 삭제된다.
		따라서 앞에서 정의한 makeCookie()메소드를 사용한다. */
